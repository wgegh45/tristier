        ...
        # ============================================================
            ...
            if len(entries) >= 2 or total_masks >= 2:
                ...
                if mask_positions:
                    ...
                    combined_processed_single = combined_text
                
                # 各モデルで予測（1つのMASKのみ）
                all_model_predictions = {}
                for model_name, model in models.items():
                    predictions = model.predict_masks(combined_processed_single, use_full_context=USE_FULL_LINE_CONTEXT)
                    all_model_predictions[model_name] = predictions
